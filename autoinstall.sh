...
apt-get -qq update
DEBIAN_FRONTEND=noninteractive apt-get -qq install desktop-base xscreensaver dbus-x11 xfce4 task-xfce-desktop less bzip2 zip unzip tasksel wget chrome-remote-desktop google-chrome-stable
